...
public class Catalog_getBookPrice_RequestStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public Catalog_getBookPrice_RequestStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        edu.aspire.bookstore.service.Catalog_getBookPrice_RequestStruct instance = new edu.aspire.bookstore.service.Catalog_getBookPrice_RequestStruct();
        edu.aspire.bookstore.service.Catalog_getBookPrice_RequestStruct_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_String_1_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new edu.aspire.bookstore.service.Catalog_getBookPrice_RequestStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        edu.aspire.bookstore.service.Catalog_getBookPrice_RequestStruct instance = (edu.aspire.bookstore.service.Catalog_getBookPrice_RequestStruct)obj;
