...
public class CatalogService_SerializerRegistry implements SerializerConstants {
    public CatalogService_SerializerRegistry() {
    }
    ...
    public TypeMappingRegistry getRegistry() {
        ...
        {
            QName type = new QName("http://www.java2aspire.com/book/types", "getBookPriceResponse");
            CombinedSerializer serializer = new edu.aspire.bookstore.service.Catalog_getBookPrice_ResponseStruct_SOAPSerializer(type,
            ...
            registerSerializer(mapping,edu.aspire.bookstore.service.Catalog_getBookPrice_ResponseStruct.class, type, serializer);
        }
        {
            QName type = new QName("http://www.java2aspire.com/book/types", "getBookPrice");
            CombinedSerializer serializer = new edu.aspire.bookstore.service.Catalog_getBookPrice_RequestStruct_SOAPSerializer(type,
                DONT_ENCODE_TYPE, NULLABLE, SOAPConstants.NS_SOAP_ENCODING);
            serializer = new ReferenceableSerializerImpl(DONT_SERIALIZE_AS_REF, serializer, SOAPVersion.SOAP_11);
            registerSerializer(mapping,edu.aspire.bookstore.service.Catalog_getBookPrice_RequestStruct.class, type, serializer);
        }
        return registry;
    }
