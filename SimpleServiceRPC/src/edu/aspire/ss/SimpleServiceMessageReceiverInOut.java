...
public class SimpleServiceMessageReceiverInOut extends
		...
		try {
			...
			if ((op.getName() != null)
				...
				if ("concat".equals(methodName)) {
					...
					edu.aspire.ss.ConcatResponse concatResponse7 = null;
					edu.aspire.ss.Concat wrappedParam = (edu.aspire.ss.Concat) fromOM(
							msgContext.getEnvelope().getBody()
									.getFirstElement(),
							edu.aspire.ss.Concat.class);
	...
	//
	private org.apache.axiom.om.OMElement toOM(edu.aspire.ss.Concat param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param.getOMElement(edu.aspire.ss.Concat.MY_QNAME,
	...
	private java.lang.Object fromOM(org.apache.axiom.om.OMElement param,
		...
		try {
			...
			if (edu.aspire.ss.Concat.class.equals(type)) {

				return edu.aspire.ss.Concat.Factory.parse(param
